...
A map shaded by top corporate income tax rates. 
...
Import population data (estimate, July 2019) on state populations from [Wikipedia](https://en.wikipedia.org/wiki/List_of_U.S._states_and_territories_by_population)
